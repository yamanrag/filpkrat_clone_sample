...
import { todayDeal } from "./Data/todayDeal.js"
...
/*********************************bestofElctronic_product_item */
let topdeals_product_itemEl = document.querySelector(".topdeals_product_item")
let todaydealsProduct_html = ""

console.log(todayDeal)
todayDeal.forEach(el => {

    /* class move div to a tag */  //change done
    
    todaydealsProduct_html += `
    <div >
        <a href="${el.link}" class="topdeals_item">   

        <div class="topdeals_image_Product">
            <img
                src="${el.img}" />
        </div>
        <div class="topdealsOption">
            <p class="topdeals_name">${el.productName}</p>
            <p class="topdeals_discount">${el.discount}</p>
            <p class="topdeals_brand">${el.desc}</p>
        </div>
        </a>
...
topdeals_product_itemEl.innerHTML = todaydealsProduct_html
